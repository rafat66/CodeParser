...
[Uploading CodeParser - Tutorial  video.webm…]()
ffmpeg -i CodeParser-Tutorial.mp4 -vf "scale=1280:-2" -c:v libx264 -crf 32 -preset slow -c:a aac -b:a 64k CodeParser-Tutorial-24MB.mp4
